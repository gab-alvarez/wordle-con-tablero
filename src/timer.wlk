...
object timer inherits Componente{
	...
	method minuto()= (tiempoRestante.div(60)).truncate(6).toString()     
	
	//devuelve las decenas de los segundos restantes en un string
	method segundo1()= ((tiempoRestante%60).div(10)).truncate(5).toString()			// no estan consistentes los calculos pero funcionan bien ,sugiero no tocar
